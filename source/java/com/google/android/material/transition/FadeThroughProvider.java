...
public final class FadeThroughProvider implements VisibilityAnimatorProvider {
    ...
    private static Animator createFadeThroughAnimator(final View view, final float f7, final float f10, @FloatRange(from = 0.0d, to = 1.0d) final float f11, @FloatRange(from = 0.0d, to = 1.0d) final float f12, final float f13) {
    ...
    public Animator createAppear(@NonNull ViewGroup viewGroup, @NonNull View view) {
        ...
        float f7 = alpha;
        return createFadeThroughAnimator(view, 0.0f, f7, this.progressThreshold, 1.0f, f7);
    }
    ...
    public Animator createDisappear(@NonNull ViewGroup viewGroup, @NonNull View view) {
        ...
        float f7 = alpha;
        return createFadeThroughAnimator(view, f7, 0.0f, 0.0f, this.progressThreshold, f7);
    }
