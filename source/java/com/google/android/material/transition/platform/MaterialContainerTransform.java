...
public final class MaterialContainerTransform extends Transition {
    ...
    public static class ProgressThresholds {
        ...
        public ProgressThresholds(@FloatRange(from = 0.0d, to = 1.0d) float f7, @FloatRange(from = 0.0d, to = 1.0d) float f10) {
            this.start = f7;
            this.end = f10;
        }
    ...
    public static final class TransitionDrawable extends Drawable {
        ...
        private static float calculateElevationDyMultiplier(RectF rectF, float f7) {
            return (rectF.centerY() / f7) * SHADOW_DY_MULTIPLIER_ADJUSTMENT;
        }
        ...
        private void updateProgress(float f7) {
            ...
            if (this.entering) {
                lerp = TransitionUtils.lerp(0.0f, 255.0f, f7);
            } else {
                lerp = TransitionUtils.lerp(255.0f, 0.0f, f7);
            }
            ...
            float lerp2 = TransitionUtils.lerp(0.0f, 1.0f, floatValue, floatValue2, f7);
            if (!shouldMaskStartBounds) {
                lerp2 = 1.0f - lerp2;
            }
            ...
            float f20 = this.currentElevation;
            float f21 = (int) (calculateElevationDyMultiplier * f20);
            this.currentElevationDy = f21;
            this.shadowPaint.setShadowLayer(f20, (int) (calculateElevationDxMultiplier * f20), f21, SHADOW_COLOR);
            this.fadeModeResult = this.fadeModeEvaluator.evaluate(f7, ((Float) Preconditions.checkNotNull(Float.valueOf(this.progressThresholds.fade.start))).floatValue(), ((Float) Preconditions.checkNotNull(Float.valueOf(this.progressThresholds.fade.end))).floatValue(), 0.35f);
    ...
    private static RectF calculateDrawableBounds(View view, @Nullable View view2, float f7, float f10) {
        if (view2 != null) {
            RectF locationInWindow = TransitionUtils.getLocationInWindow(view2);
            locationInWindow.offset(f7, f10);
    ...
    private static void captureValues(@NonNull TransitionValues transitionValues, @Nullable View view, @IdRes int i, @Nullable ShapeAppearanceModel shapeAppearanceModel) {
        ...
        if (view3.getParent() == null) {
            locationInWindow = TransitionUtils.getRelativeBounds(view3);
        } else {
            locationInWindow = TransitionUtils.getLocationInWindow(view3);
        }
        transitionValues.values.put(PROP_BOUNDS, locationInWindow);
        transitionValues.values.put(PROP_SHAPE_APPEARANCE, captureShapeAppearance(view3, locationInWindow, shapeAppearanceModel));
    }
    ...
    private boolean isEntering(@NonNull RectF rectF, @NonNull RectF rectF2) {
        ...
        if (i != 0) {
            ...
            androidx.core.view.inputmethod.a.e(this.transitionDirection, "Invalid transition direction: ");
            return false;
        }
        ...
        if (transitionValues != null && transitionValues2 != null) {
            ...
            if (rectF != null && shapeAppearanceModel != null) {
                ...
                if (rectF2 != null && shapeAppearanceModel2 != null) {
                    ...
                    float f7 = -locationInWindow.left;
                    float f10 = -locationInWindow.top;
                    RectF calculateDrawableBounds = calculateDrawableBounds(findAncestorById, view2, f7, f10);
                    rectF.offset(f7, f10);
