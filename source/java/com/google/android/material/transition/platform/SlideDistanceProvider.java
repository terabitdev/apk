...
public final class SlideDistanceProvider implements VisibilityAnimatorProvider {
    ...
    private static Animator createTranslationAppearAnimator(View view, View view2, int i, @Px int i3) {
        float f7;
        float f10;
                ...
                if (i != 48) {
                    if (i != 80) {
                        if (i != 8388611) {
                            ...
                            i.k(i6.m(i, "Invalid slide direction: "));
                            return null;
                        }
                        if (isRtl(view)) {
                            f7 = i3 + translationX;
                        ...
                        return createTranslationXAnimator(view2, f7, translationX, translationX);
                    }
    ...
    private static Animator createTranslationDisappearAnimator(View view, View view2, int i, @Px int i3) {
        float f7;
        float f10;
        float translationX = view2.getTranslationX();
        float translationY = view2.getTranslationY();
            ...
            if (i != 5) {
                if (i != 48) {
                    if (i != 80) {
                        ...
                        return createTranslationXAnimator(view2, translationX, f7, translationX);
                    }
    ...
    private static Animator createTranslationXAnimator(final View view, float f7, float f10, final float f11) {
        ObjectAnimator ofPropertyValuesHolder = ObjectAnimator.ofPropertyValuesHolder(view, PropertyValuesHolder.ofFloat((Property<?, Float>) View.TRANSLATION_X, f7, f10));
    ...
    private static Animator createTranslationYAnimator(final View view, float f7, float f10, final float f11) {
        ObjectAnimator ofPropertyValuesHolder = ObjectAnimator.ofPropertyValuesHolder(view, PropertyValuesHolder.ofFloat((Property<?, Float>) View.TRANSLATION_Y, f7, f10));
    ...
    public void setSlideDistance(@Px int i) {
        if (i >= 0) {
            ...
            i.k("Slide distance must be positive. If attempting to reverse the direction of the slide, use setSlideEdge(int) instead.");
        }
    }
