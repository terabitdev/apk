...
public final class MaterialSharedAxis extends MaterialVisibility<VisibilityAnimatorProvider> {
    ...
    public MaterialSharedAxis(int i, boolean z10) {
        super(createPrimaryAnimatorProvider(i, z10), createSecondaryAnimatorProvider());
        this.axis = i;
        this.forward = z10;
    }

    private static VisibilityAnimatorProvider createPrimaryAnimatorProvider(int i, boolean z10) {
        int i3;
        int i8;
        if (i != 0) {
            if (i != 1) {
            ...
            return new SlideDistanceProvider(i8);
        }
        if (z10) {
