...
public class ScaledDrawableWrapper extends DrawableWrapperCompat {
    ...
    public ScaledDrawableWrapper(@NonNull Drawable drawable, int i, int i3) {
        super(drawable);
        this.state = new ScaledDrawableWrapperState(getConstantStateFrom(drawable), i, i3);
    }
    ...
    public static final class ScaledDrawableWrapperState extends Drawable.ConstantState {
        ...
        public ScaledDrawableWrapperState(@Nullable Drawable.ConstantState constantState, int i, int i3) {
