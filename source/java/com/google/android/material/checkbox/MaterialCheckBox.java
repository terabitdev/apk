...
public class MaterialCheckBox extends AppCompatCheckBox {
    ...
    */
    public MaterialCheckBox(Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        TintTypedArray obtainTintedStyledAttributes = ThemeEnforcement.obtainTintedStyledAttributes(context2, attributeSet, R.styleable.MaterialCheckBox, i, i3, new int[0]);
    ...
    public void setCheckedState(int i) {
        ...
        if (this.checkedState != i) {
            ...
            if (!this.broadcasting) {
                ...
                if (Build.VERSION.SDK_INT >= 26 && (e10 = c.e(getContext().getSystemService(c.r()))) != null) {
    ...
    public static class SavedState extends View.BaseSavedState {
        ...
        public String toString() {
            ...
            return i6.q(sb, getCheckedStateString(), "}");
        }
