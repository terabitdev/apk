...
public class MaterialCardView extends CardView implements Checkable, Shapeable {
    ...
    */
    public MaterialCardView(Context context, AttributeSet attributeSet, int i) {
        ...
        TypedArray obtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(getContext(), attributeSet, com.google.android.material.R.styleable.MaterialCardView, i, i3, new int[0]);
        MaterialCardViewHelper materialCardViewHelper = new MaterialCardViewHelper(this, attributeSet, i, i3);
    ...
    public void setAncestorContentPadding(int i, int i3, int i8, int i10) {
        super.setContentPadding(i, i3, i8, i10);
    }
    ...
    @Override // androidx.cardview.widget.CardView
    public void setContentPadding(int i, int i3, int i8, int i10) {
        this.cardViewHelper.setUserContentPadding(i, i3, i8, i10);
    }
