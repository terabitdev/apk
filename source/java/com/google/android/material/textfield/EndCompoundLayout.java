...
public class EndCompoundLayout extends LinearLayout {
                ...
                if (i != 0) {
                    if (i != 1) {
                        if (i != 2) {
                            ...
                            i.k(i6.m(i, "Invalid end icon mode: "));
                            return null;
                        }
    ...
    public EndCompoundLayout(TextInputLayout textInputLayout, TintTypedArray tintTypedArray) {
        ...
        this.editTextWatcher = new TextWatcherAdapter() { // from class: com.google.android.material.textfield.EndCompoundLayout.1
            ...
            public void beforeTextChanged(CharSequence charSequence, int i, int i3, int i8) {
                EndCompoundLayout.this.getEndIconDelegate().beforeEditTextChanged(charSequence, i, i3, i8);
            }
        };
    ...
    public int getSuffixTextEndOffset() {
        ...
        if (!isEndIconVisible() && !isErrorIconVisible()) {
            ...
            measuredWidth = this.endIconView.getMeasuredWidth() + ((ViewGroup.MarginLayoutParams) this.endIconView.getLayoutParams()).getMarginStart();
        }
    ...
    public void setEndIconMinSize(@Px int i) {
        ...
        i.k("endIconSize cannot be less than 0");
    }
