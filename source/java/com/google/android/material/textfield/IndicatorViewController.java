...
public final class IndicatorViewController {
    ...
    private void createCaptionAnimators(@NonNull List<Animator> list, boolean z10, @Nullable TextView textView, int i, int i3, int i8) {
        boolean z11;
    ...
    private ObjectAnimator createCaptionOpacityAnimator(TextView textView, boolean z10) {
        ...
        ObjectAnimator ofFloat = ObjectAnimator.ofFloat(textView, (Property<TextView, Float>) View.ALPHA, f7);
        if (z10) {
    ...
    private int getIndicatorPadding(boolean z10, @DimenRes int i, int i3) {
        if (z10) {
    ...
    private void setCaptionViewVisibilities(int i, int i3) {
    ...
    private void updateCaptionViewsVisibility(final int i, final int i3, boolean z10) {
        ...
        if (z10) {
            ...
            indicatorViewController.createCaptionAnimators(arrayList, this.helperTextEnabled, this.helperTextView, 2, i, i3);
            indicatorViewController.createCaptionAnimators(arrayList, indicatorViewController.errorEnabled, indicatorViewController.errorView, 1, i, i3);
            ...
            indicatorViewController = this;
            setCaptionViewVisibilities(i, i3);
        }
        indicatorViewController.textInputView.updateEditTextBackground();
        indicatorViewController.textInputView.updateLabelState(z10);
