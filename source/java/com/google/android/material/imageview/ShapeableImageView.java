...
public class ShapeableImageView extends AppCompatImageView implements Shapeable {
    ...
    */
    public ShapeableImageView(Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        TypedArray obtainStyledAttributes = context2.obtainStyledAttributes(attributeSet, R.styleable.ShapeableImageView, i, i3);
        setLayerType(2, null);
    ...
    private void updateShapeMask(int i, int i3) {
        this.destination.set(getPaddingLeft(), getPaddingTop(), i - getPaddingRight(), i3 - getPaddingBottom());
        this.pathProvider.calculatePath(this.shapeAppearanceModel, 1.0f, this.destination, this.path);
        this.maskPath.rewind();
        this.maskPath.addPath(this.path);
        this.maskRect.set(0.0f, 0.0f, i, i3);
    ...
    public void onSizeChanged(int i, int i3, int i8, int i10) {
        ...
        updateShapeMask(i, i3);
    }

    public void setContentPadding(@Dimension int i, @Dimension int i3, @Dimension int i8, @Dimension int i10) {
        this.startContentPadding = Integer.MIN_VALUE;
        this.endContentPadding = Integer.MIN_VALUE;
        super.setPadding((super.getPaddingLeft() - this.leftContentPadding) + i, (super.getPaddingTop() - this.topContentPadding) + i3, (super.getPaddingRight() - this.rightContentPadding) + i8, (super.getPaddingBottom() - this.bottomContentPadding) + i10);
    ...
    public void setContentPaddingRelative(@Dimension int i, @Dimension int i3, @Dimension int i8, @Dimension int i10) {
        int i11;
        super.setPaddingRelative((super.getPaddingStart() - getContentPaddingStart()) + i, (super.getPaddingTop() - this.topContentPadding) + i3, (super.getPaddingEnd() - getContentPaddingEnd()) + i8, (super.getPaddingBottom() - this.bottomContentPadding) + i10);
        if (isRtl()) {
            i11 = i8;
        } else {
            i11 = i;
    ...
    @Override // android.view.View
    public void setPadding(@Dimension int i, @Dimension int i3, @Dimension int i8, @Dimension int i10) {
        super.setPadding(getContentPaddingLeft() + i, getContentPaddingTop() + i3, getContentPaddingRight() + i8, getContentPaddingBottom() + i10);
    }

    @Override // android.view.View
    public void setPaddingRelative(@Dimension int i, @Dimension int i3, @Dimension int i8, @Dimension int i10) {
        super.setPaddingRelative(getContentPaddingStart() + i, getContentPaddingTop() + i3, getContentPaddingEnd() + i8, getContentPaddingBottom() + i10);
    }
