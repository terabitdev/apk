...
public class LoadingIndicatorAnimatorDelegate {
    ...
    private static final Property<LoadingIndicatorAnimatorDelegate, Float> ANIMATION_FRACTION = new Property<LoadingIndicatorAnimatorDelegate, Float>(Float.class, "animationFraction") { // from class: com.google.android.material.loadingindicator.LoadingIndicatorAnimatorDelegate.2
        ...
        @Override // android.util.Property
        public void set(LoadingIndicatorAnimatorDelegate loadingIndicatorAnimatorDelegate, Float f7) {
            loadingIndicatorAnimatorDelegate.setAnimationFraction(f7.floatValue());
        }
    };
    private static final FloatPropertyCompat<LoadingIndicatorAnimatorDelegate> MORPH_FACTOR = new FloatPropertyCompat<LoadingIndicatorAnimatorDelegate>("morphFactor") { // from class: com.google.android.material.loadingindicator.LoadingIndicatorAnimatorDelegate.3
        ...
        public void setValue(LoadingIndicatorAnimatorDelegate loadingIndicatorAnimatorDelegate, float f7) {
            loadingIndicatorAnimatorDelegate.setMorphFactor(f7);
        }
    ...
    private void updateIndicatorRotation(int i) {
        float f7 = this.morphFactorTarget - 1;
        float f10 = this.morphFactor - f7;
        float f11 = i / 650.0f;
        if (f11 == 1.0f) {
            f11 = 0.0f;
        }
        this.indicatorState.rotationDegree = ((f10 * 90.0f) + ((f11 * 50.0f) + (f7 * 140.0f))) % 360.0f;
    }
    ...
    public void setAnimationFraction(float f7) {
        ...
        updateIndicatorRotation((int) (f7 * 650.0f));
    ...
    @VisibleForTesting
    public void setMorphFactor(float f7) {
        this.morphFactor = f7;
