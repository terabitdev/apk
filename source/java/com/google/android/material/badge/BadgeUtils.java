...
public class BadgeUtils {
    ...
    public static void detachBadgeDrawable(@Nullable BadgeDrawable badgeDrawable, @NonNull Toolbar toolbar, @IdRes int i) {
        ...
        i6.t(i, "Trying to remove badge from a null menuItemView: ", LOG_TAG);
    }
    ...
    public static void updateBadgeBounds(@NonNull Rect rect, float f7, float f10, float f11, float f12) {
        rect.set((int) (f7 - f11), (int) (f10 - f12), (int) (f7 + f11), (int) (f10 + f12));
    }
