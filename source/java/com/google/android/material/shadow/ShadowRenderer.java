...
public class ShadowRenderer {
    ...
    public void drawCornerShadow(@NonNull Canvas canvas, @Nullable Matrix matrix, @NonNull RectF rectF, int i, float f7, float f10) {
        boolean z10;
        float f11;
        if (f10 < 0.0f) {
            z10 = true;
    ...
    public void drawInnerCornerShadow(@NonNull Canvas canvas, @Nullable Matrix matrix, @NonNull RectF rectF, int i, float f7, float f10, @NonNull float[] fArr) {
        if (f10 > 0.0f) {
            f7 += f10;
            f10 = -f10;
        }
