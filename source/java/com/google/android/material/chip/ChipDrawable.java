...
public class ChipDrawable extends MaterialShapeDrawable implements TintAwareDrawable, Drawable.Callback, TextDrawableHelper.TextDrawableDelegate {
    ...
    private ChipDrawable(@NonNull Context context, AttributeSet attributeSet, @AttrRes int i, @StyleRes int i3) {
    ...
    @NonNull
    public static ChipDrawable createFromAttributes(@NonNull Context context, @Nullable AttributeSet attributeSet, @AttrRes int i, @StyleRes int i3) {
        ChipDrawable chipDrawable = new ChipDrawable(context, attributeSet, i, i3);
        chipDrawable.loadFromAttributes(attributeSet, i, i3);
        return chipDrawable;
    }
    ...
    private void drawChipStroke(@NonNull Canvas canvas, @NonNull Rect rect) {
        if (this.chipStrokeWidth > 0.0f && !this.isShapeThemingEnabled) {
            ...
            rectF.set((f10 / 2.0f) + f7, (f10 / 2.0f) + rect.top, rect.right - (f10 / 2.0f), rect.bottom - (f10 / 2.0f));
    ...
    private void loadFromAttributes(@Nullable AttributeSet attributeSet, @AttrRes int i, @StyleRes int i3) {
        TypedArray obtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(this.context, attributeSet, com.google.android.material.R.styleable.Chip, i, i3, new int[0]);
    ...
    private boolean onStateChange(@NonNull int[] iArr, @NonNull int[] iArr2) {
        ...
        if (colorStateList != null) {
            i = colorStateList.getColorForState(iArr, this.currentChipSurfaceColor);
        } else {
            i = 0;
        }
        int compositeElevationOverlayIfNeeded = compositeElevationOverlayIfNeeded(i);
        boolean z14 = true;
        ...
        if (colorStateList2 != null) {
            i3 = colorStateList2.getColorForState(iArr, this.currentChipBackgroundColor);
        } else {
            i3 = 0;
        }
        int compositeElevationOverlayIfNeeded2 = compositeElevationOverlayIfNeeded(i3);
        ...
        if (colorStateList3 != null) {
            i8 = colorStateList3.getColorForState(iArr, this.currentChipStrokeColor);
        } else {
            i8 = 0;
        }
        if (this.currentChipStrokeColor != i8) {
            this.currentChipStrokeColor = i8;
            onStateChange = true;
        }
        if (this.compatRippleColor != null && RippleUtils.shouldDrawRippleCompat(iArr)) {
            i10 = this.compatRippleColor.getColorForState(iArr, this.currentCompatRippleColor);
        } else {
            i10 = 0;
        }
        if (this.currentCompatRippleColor != i10) {
            this.currentCompatRippleColor = i10;
            if (this.useCompatRipple) {
                onStateChange = true;
            }
        }
        if (this.textDrawableHelper.getTextAppearance() != null && this.textDrawableHelper.getTextAppearance().getTextColor() != null) {
            i11 = this.textDrawableHelper.getTextAppearance().getTextColor().getColorForState(iArr, this.currentTextColor);
        } else {
            i11 = 0;
        }
        if (this.currentTextColor != i11) {
            this.currentTextColor = i11;
            onStateChange = true;
        }
        if (hasState(getState(), R.attr.state_checked) && this.checkable) {
            z12 = true;
        } else {
            z12 = false;
        }
        ...
        if (colorStateList4 != null) {
            i12 = colorStateList4.getColorForState(iArr, this.currentTint);
        } else {
            i12 = 0;
        }
        if (this.currentTint != i12) {
            this.currentTint = i12;
            this.tintFilter = DrawableUtils.updateTintFilter(this, this.tint, this.tintMode);
        } else {
            z14 = onStateChange;
        }
        if (isStateful(this.chipIcon)) {
            z14 |= this.chipIcon.setState(iArr);
        }
        if (isStateful(this.checkedIcon)) {
            z14 |= this.checkedIcon.setState(iArr);
        }
        if (isStateful(this.closeIcon)) {
            int[] iArr3 = new int[iArr.length + iArr2.length];
            System.arraycopy(iArr, 0, iArr3, 0, iArr.length);
            System.arraycopy(iArr2, 0, iArr3, iArr.length, iArr2.length);
            z14 |= this.closeIcon.setState(iArr3);
        }
        if (isStateful(this.closeIconRipple)) {
            z14 |= this.closeIconRipple.setState(iArr2);
        }
        if (z14) {
            invalidateSelf();
        }
    ...
    public boolean isStateful() {
        if (!isStateful(this.chipSurfaceColor) && !isStateful(this.chipBackgroundColor) && !isStateful(this.chipStrokeColor)) {
            if ((!this.useCompatRipple || !isStateful(this.compatRippleColor)) && !isStateful(this.textDrawableHelper.getTextAppearance()) && !canShowCheckedIcon() && !isStateful(this.chipIcon) && !isStateful(this.checkedIcon) && !isStateful(this.tint)) {
                return false;
            }
            return true;
        }
    ...
    public boolean refreshCloseIconFocus(boolean z10) {
        int[] iArr;
