...
public abstract class SheetDialog<C extends SheetCallback> extends AppCompatDialog {
    ...
    public SheetDialog(@NonNull Context context, @StyleRes int i, @AttrRes int i3, @StyleRes int i8) {
        super(context, getThemeResId(context, i, i3, i8));
    ...
    private static int getThemeResId(@NonNull Context context, @StyleRes int i, @AttrRes int i3, @StyleRes int i8) {
        if (i == 0) {
    ...
    public void setSheetEdge(@GravityInt int i) {
        ...
        if (frameLayout != null) {
            ...
            b.d.j("Sheet view has been laid out; sheet edge cannot be changed once the sheet has been laid out.");
            return;
        }
        b.d.j("Sheet view reference is null; sheet edge cannot be changed if the sheet view is null.");
    }
