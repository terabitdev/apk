...
public class HctSolver {
    ...
    public static double[] bisectToLimit(double d10, double d11) {
        ...
        for (int i = 0; i < 3; i++) {
            ...
            if (d12 != d13) {
                ...
                int i8 = criticalPlaneBelow;
                double d15 = d14;
                for (int i10 = 0; i10 < 8 && Math.abs(i8 - i3) > 1; i10++) {
                    int floor = (int) Math.floor((i3 + i8) / 2.0d);
                    double[] coordinate = setCoordinate(dArr, CRITICAL_PLANES[floor], dArr2, i);
                    double hueOf2 = hueOf(coordinate);
                    if (areInCyclicOrder(d15, d11, hueOf2)) {
                        i8 = floor;
                        dArr2 = coordinate;
                    } else {
                        d15 = hueOf2;
    ...
    /* JADX WARN: Code restructure failed: missing block: B:16:0x003e, code lost:
        ...
        if (areInCyclicOrder(r10, r12, r14) != false) goto L14;
     */
    /*
    ...
    */
    public static double[][] bisectToSegment(double d10, double d11) {
        ...
        boolean z11 = true;
        for (int i = 0; i < 12; i++) {
            double[] nthVertex = nthVertex(d10, i);
            if (nthVertex[0] < 0.0d) {
                d12 = d14;
            } else {
                ...
                if (!z10) {
                    ...
                    if (areInCyclicOrder(d13, d11, hueOf)) {
                        z11 = false;
                        d14 = hueOf;
                        dArr2 = nthVertex;
                    } else {
    ...
    public static int findResultByJ(double d10, double d11, double d12) {
        ...
        while (i < 5) {
            ...
            if (d11 != 0.0d && sqrt != 0.0d) {
                d13 = d11 / Math.sqrt(d17);
            } else {
                d13 = 0.0d;
            }
            double d18 = d15;
            double d19 = sqrt;
            double pow2 = Math.pow(d13 * pow, 1.1111111111111112d);
            double pow3 = (Math.pow(d17, (d16 / viewingConditions.getC()) / viewingConditions.getZ()) * viewingConditions.getAw()) / viewingConditions.getNbb();
            double d20 = (((0.305d + pow3) * 23.0d) * pow2) / (((108.0d * pow2) * sin) + (((pow2 * 11.0d) * cos) + (23.0d * ncb)));
            double d21 = d20 * cos;
            double d22 = d20 * sin;
            double d23 = pow3 * 460.0d;
            double[] matrixMultiply = MathUtils.matrixMultiply(new double[]{inverseChromaticAdaptation(((288.0d * d22) + ((451.0d * d21) + d23)) / 1403.0d), inverseChromaticAdaptation(((d23 - (891.0d * d21)) - (261.0d * d22)) / 1403.0d), inverseChromaticAdaptation(((d23 - (d21 * 220.0d)) - (d22 * 6300.0d)) / 1403.0d)}, LINRGB_FROM_SCALED_DISCOUNT);
            double d24 = matrixMultiply[0];
            if (d24 < 0.0d) {
                break;
            }
            double d25 = matrixMultiply[1];
            if (d25 < 0.0d) {
                break;
            }
            double d26 = matrixMultiply[2];
            if (d26 < 0.0d) {
                break;
            }
            double[] dArr = Y_FROM_LINRGB;
            double d27 = (dArr[2] * d26) + (dArr[1] * d25) + (dArr[0] * d24);
            if (d27 <= 0.0d) {
                return 0;
            }
            if (i != 4) {
    ...
    public static double inverseChromaticAdaptation(double d10) {
        ...
        return Math.pow(Math.max(0.0d, (27.13d * abs) / (400.0d - abs)), 2.380952380952381d) * MathUtils.signum(d10);
    }
    ...
    public static double[] nthVertex(double d10, int i) {
        ...
        if (i < 8) {
            ...
            if (isBounded(d17)) {
                return new double[]{d15, d17, d11};
            }
            return new double[]{-1.0d, -1.0d, -1.0d};
        }
        double d18 = ((d10 - (d12 * d11)) - (d13 * d15)) / d14;
        if (isBounded(d18)) {
            return new double[]{d11, d15, d18};
        }
        return new double[]{-1.0d, -1.0d, -1.0d};
    }
