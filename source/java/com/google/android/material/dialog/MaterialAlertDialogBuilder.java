...
public class MaterialAlertDialogBuilder extends AlertDialog.Builder {
    ...
    public MaterialAlertDialogBuilder(@NonNull Context context, int i) {
        ...
        this.backgroundInsets = MaterialDialogs.getDialogBackgroundInsets(context2, i3, i8);
        int color = MaterialColors.getColor(context2, com.google.android.material.R.attr.colorSurface, getClass().getCanonicalName());
        TypedArray obtainStyledAttributes = context2.obtainStyledAttributes(null, com.google.android.material.R.styleable.MaterialAlertDialog, i3, i8);
        ...
        MaterialShapeDrawable materialShapeDrawable = new MaterialShapeDrawable(context2, null, i3, i8);
    ...
    @Override // androidx.appcompat.app.AlertDialog.Builder
    @NonNull
    public MaterialAlertDialogBuilder setSingleChoiceItems(@ArrayRes int i, int i3, @Nullable DialogInterface.OnClickListener onClickListener) {
        return (MaterialAlertDialogBuilder) super.setSingleChoiceItems(i, i3, onClickListener);
    }
