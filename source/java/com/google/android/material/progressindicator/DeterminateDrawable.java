...
public final class DeterminateDrawable<S extends BaseProgressIndicatorSpec> extends DrawableWithAnimatedVisibilityChange {
    ...
    private static final FloatPropertyCompat<DeterminateDrawable<?>> INDICATOR_LENGTH_IN_LEVEL = new FloatPropertyCompat<DeterminateDrawable<?>>("indicatorLevel") { // from class: com.google.android.material.progressindicator.DeterminateDrawable.1
        ...
        public void setValue(DeterminateDrawable<?> determinateDrawable, float f7) {
            ...
            determinateDrawable.maybeStartAmplitudeAnimator((int) f7);
        }
    };
    ...
    private void maybeInitializeAmplitudeAnimator() {
        ...
        this.amplitudeAnimator.addUpdateListener(new p(this, 3));
    }
    ...
    public void maybeStartAmplitudeAnimator(int i) {
        if (this.baseSpec.hasWavyEffect(true)) {
            ...
            float f7 = this.targetAmplitudeFraction;
            ValueAnimator valueAnimator = this.amplitudeAnimator;
            if (amplitudeFractionFromLevel != f7) {
    ...
    private void setAmplitudeFraction(float f7) {
        this.activeIndicator.amplitudeFraction = f7;
        invalidateSelf();
    }

    public void setIndicatorFraction(float f7) {
        this.activeIndicator.endFraction = f7;
        invalidateSelf();
    }
        ...
        if (!getBounds().isEmpty() && isVisible() && canvas.getClipBounds(this.clipBounds)) {
            ...
            if (i > 0) {
                if (!(drawingDelegate instanceof LinearDrawingDelegate)) {
                    i = (int) ((MathUtils.clamp(getIndicatorFraction(), 0.0f, 0.01f) * i) / 0.01f);
                }
    ...
    public boolean onLevelChange(int i) {
        float amplitudeFractionFromLevel = getAmplitudeFractionFromLevel(i);
        boolean z10 = this.skipAnimationOnLevelChange;
    ...
    public void setEnforcedDrawing(boolean z10) {
        if (z10 && !this.phaseAnimator.isRunning()) {
            this.phaseAnimator.start();
        } else if (!z10 && this.phaseAnimator.isRunning()) {
