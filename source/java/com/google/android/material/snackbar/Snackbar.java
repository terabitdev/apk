...
public class Snackbar extends BaseTransientBottomBar<Snackbar> {
    ...
    @NonNull
    public static Snackbar make(@NonNull View view, @StringRes int i, int i3) {
        return make(view, view.getResources().getText(i), i3);
    }
    ...
    private static Snackbar makeInternal(@Nullable Context context, @NonNull View view, @NonNull CharSequence charSequence, int i) {
        ...
        if (findSuitableParent != null) {
            ...
            SnackbarContentLayout snackbarContentLayout = (SnackbarContentLayout) from.inflate(i3, findSuitableParent, false);
            Snackbar snackbar = new Snackbar(context, findSuitableParent, snackbarContentLayout, snackbarContentLayout);
            snackbar.setText(charSequence);
            snackbar.setDuration(i);
            return snackbar;
        }
        i.k("No suitable parent found from the given view. Please provide a valid view.");
        return null;
    }
    ...
    public int getDuration() {
        ...
        if (i3 >= 29) {
            ...
            return this.accessibilityManager.getRecommendedTimeoutMillis(duration, i | 3);
        }
        if (z10 && this.accessibilityManager.isTouchExplorationEnabled()) {
            return -2;
        }
        return duration;
    }
    ...
    public Snackbar setAction(@Nullable CharSequence charSequence, @Nullable View.OnClickListener onClickListener) {
        ...
        if (!TextUtils.isEmpty(charSequence) && onClickListener != null) {
            ...
            actionView.setOnClickListener(new j(4, this, onClickListener));
            return this;
        }
