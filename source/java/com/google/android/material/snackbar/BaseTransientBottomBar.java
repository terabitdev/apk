...
public abstract class BaseTransientBottomBar<B extends BaseTransientBottomBar<B>> {
    ...
    /* compiled from: r8-map-id-e907cdfad2df14fd92982b00c76004907cc554632fe47bc57470e213e2fdbf5b */
    @IntRange(from = GuidedAction.ACTION_ID_NEXT)
    @Retention(RetentionPolicy.SOURCE)
    @RestrictTo({RestrictTo.Scope.LIBRARY_GROUP})
    /* loaded from: classes4.dex */
    ...
    public BaseTransientBottomBar(@NonNull Context context, @NonNull ViewGroup viewGroup, @NonNull View view, @NonNull com.google.android.material.snackbar.ContentViewCallback contentViewCallback) {
        ...
        if (viewGroup != null) {
            if (view != null) {
                ...
                i.k("Transient bottom bar must have non-null callback");
                throw null;
            }
            i.k("Transient bottom bar must have non-null content");
            throw null;
        }
        i.k("Transient bottom bar must have non-null parent");
        throw null;
    }
    ...
    public void updateMargins() {
        ...
        if (this.view.getParent() != null) {
            ...
            ViewGroup.MarginLayoutParams marginLayoutParams = (ViewGroup.MarginLayoutParams) layoutParams;
            int i3 = this.view.originalMargins.bottom + i;
            ...
            if (marginLayoutParams.bottomMargin == i3 && marginLayoutParams.leftMargin == i8 && marginLayoutParams.rightMargin == i10 && marginLayoutParams.topMargin == i11) {
                z10 = false;
            } else {
                z10 = true;
            }
    ...
    public B setAnchorView(@IdRes int i) {
        ...
        i.k(i6.m(i, "Unable to find anchor view with id: "));
        return null;
    }
    ...
    public static abstract class BaseCallback<B> {
        ...
        public void onDismissed(B b10, int i) {
        }
    }
