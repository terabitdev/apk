...
public class TooltipDrawable extends MaterialShapeDrawable implements TextDrawableHelper.TextDrawableDelegate {
    ...
    private TooltipDrawable(@NonNull Context context, AttributeSet attributeSet, @AttrRes int i, @StyleRes int i3) {
    ...
    private float calculatePointerOffset() {
        int i;
        int i3 = ((this.displayFrame.right - getBounds().right) - this.locationOnScreenX) - this.layoutMargin;
    ...
    @NonNull
    public static TooltipDrawable createFromAttributes(@NonNull Context context, @Nullable AttributeSet attributeSet, @AttrRes int i, @StyleRes int i3) {
        TooltipDrawable tooltipDrawable = new TooltipDrawable(context, attributeSet, i, i3);
        tooltipDrawable.loadFromAttributes(attributeSet, i, i3);
    ...
    private void loadFromAttributes(@Nullable AttributeSet attributeSet, @AttrRes int i, @StyleRes int i3) {
        TypedArray obtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(this.context, attributeSet, R.styleable.Tooltip, i, i3, new int[0]);
        this.arrowSize = this.context.getResources().getDimensionPixelSize(R.dimen.mtrl_tooltip_arrowSize);
        boolean z10 = obtainStyledAttributes.getBoolean(R.styleable.Tooltip_showMarker, true);
        this.showMarker = z10;
        if (z10) {
    ...
    public void draw(@NonNull Canvas canvas) {
        ...
        float f7 = (float) (-((Math.sqrt(2.0d) * this.arrowSize) - this.arrowSize));
    ...
    @RestrictTo({RestrictTo.Scope.LIBRARY_GROUP})
    public void setPivots(float f7, float f10) {
        this.tooltipPivotX = f7;
    ...
    public void setRevealFraction(@FloatRange(from = 0.0d, to = 1.0d) float f7) {
