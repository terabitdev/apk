...
public class FloatingActionButton extends VisibilityAwareImageButton implements TintableBackgroundView, TintableImageSourceView, ExpandableTransformationWidget, Shapeable, CoordinatorLayout.AttachedBehavior {
    ...
    public class ShadowDelegateImpl implements ShadowViewDelegate {
        ...
        @Override // com.google.android.material.shadow.ShadowViewDelegate
        public void setShadowPadding(int i, int i3, int i8, int i10) {
            FloatingActionButton.this.shadowPadding.set(i, i3, i8, i10);
            FloatingActionButton floatingActionButton = FloatingActionButton.this;
            floatingActionButton.setPadding(floatingActionButton.imagePadding + i, FloatingActionButton.this.imagePadding + i3, FloatingActionButton.this.imagePadding + i8, FloatingActionButton.this.imagePadding + i10);
        }
    }
    ...
    */
    public FloatingActionButton(@NonNull Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        TypedArray obtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(context2, attributeSet, R.styleable.FloatingActionButton, i, i3, new int[0]);
        ...
        ShapeAppearanceModel build = ShapeAppearanceModel.builder(context2, attributeSet, i, i3, ShapeAppearanceModel.PILL).build();
    ...
    public void setCustomSize(@Px int i) {
        ...
        i.k("Custom size must be non-negative");
    }
    ...
    public static class BaseBehavior<T extends FloatingActionButton> extends CoordinatorLayout.Behavior<T> {
        ...
        private boolean updateFabVisibilityForBottomSheet(@NonNull View view, @NonNull FloatingActionButton floatingActionButton) {
            ...
            CoordinatorLayout.LayoutParams layoutParams = (CoordinatorLayout.LayoutParams) floatingActionButton.getLayoutParams();
            int top = view.getTop();
            int height = (floatingActionButton.getHeight() / 2) + ((ViewGroup.MarginLayoutParams) layoutParams).topMargin;
            OnVisibilityChangedListener onVisibilityChangedListener = this.internalAutoHideListener;
            if (top < height) {
                floatingActionButton.hide(onVisibilityChangedListener, false);
                return true;
