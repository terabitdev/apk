...
public class MaterialButtonHelper {
    ...
    private Drawable createBackground() {
        ...
        materialShapeDrawable2.setStroke(f7, i);
    ...
    private void setVerticalInsets(@Dimension int i, @Dimension int i3) {
        ...
        this.materialButton.setPaddingRelative(paddingStart, (paddingTop + i) - i8, paddingEnd, (paddingBottom + i3) - i10);
    }
    ...
    private void updateStroke() {
        ...
        if (materialShapeDrawable != null) {
            ...
            if (surfaceColorStrokeDrawable != null) {
                ...
                surfaceColorStrokeDrawable.setStroke(f7, i);
            }
        }
    }
    ...
    public void updateMaskBounds(int i, int i3) {
        Drawable drawable = this.maskDrawable;
        if (drawable != null) {
            drawable.setBounds(this.insetLeft, this.insetTop, i3 - this.insetRight, i - this.insetBottom);
        }
    }
