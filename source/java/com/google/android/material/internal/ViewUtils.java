...
public class ViewUtils {
    ...
    public static Rect calculateOffsetRectFromBounds(@NonNull View view, @NonNull View view2) {
        ...
        int i8 = i - iArr2[0];
        int i10 = i3 - iArr2[1];
        return new Rect(i8, i10, view2.getWidth() + i8, view2.getHeight() + i10);
    }
    ...
    public static void doOnApplyWindowInsets(@NonNull View view, @Nullable AttributeSet attributeSet, int i, int i3, @Nullable final OnApplyWindowInsetsListener onApplyWindowInsetsListener) {
        TypedArray obtainStyledAttributes = view.getContext().obtainStyledAttributes(attributeSet, R.styleable.Insets, i, i3);
    ...
    public static class RelativePadding {
        ...
        public RelativePadding(int i, int i3, int i8, int i10) {
            this.start = i;
            this.top = i3;
            this.end = i8;
            this.bottom = i10;
    ...
    public static void doOnApplyWindowInsets(@NonNull View view, @Nullable AttributeSet attributeSet, int i, int i3) {
        doOnApplyWindowInsets(view, attributeSet, i, i3, null);
    }
