    ...
    public class NavigationMenuAdapter extends RecyclerView.Adapter<ViewHolder> {
        ...
        public int adjustItemPositionForA11yDelegate(int i) {
            ...
            for (int i8 = 0; i8 < i; i8++) {
                if (NavigationMenuPresenter.this.adapter.getItemViewType(i8) == 2 || NavigationMenuPresenter.this.adapter.getItemViewType(i8) == 3) {
                    i3--;
                }
            }
            return i3;
        ...
        private void appendTransparentIconIfMissing(int i, int i3) {
            while (i < i3) {
        ...
        private void prepareMenuItems() {
            ...
            for (int i8 = 0; i8 < size; i8++) {
                MenuItemImpl menuItemImpl = NavigationMenuPresenter.this.menu.getVisibleItems().get(i8);
        ...
        private void setAccessibilityDelegate(View view, final int i, final boolean z10) {
            ViewCompat.setAccessibilityDelegate(view, new AccessibilityDelegateCompat() { // from class: com.google.android.material.internal.NavigationMenuPresenter.NavigationMenuAdapter.1
                ...
                public void onInitializeAccessibilityNodeInfo(@NonNull View view2, @NonNull AccessibilityNodeInfoCompat accessibilityNodeInfoCompat) {
                    ...
                    accessibilityNodeInfoCompat.setCollectionItemInfo(AccessibilityNodeInfoCompat.CollectionItemInfoCompat.obtain(NavigationMenuAdapter.this.adjustItemPositionForA11yDelegate(i), 1, 1, 1, z10, view2.isSelected()));
                }
            });
        }
        ...
        public void onBindViewHolder(@NonNull ViewHolder viewHolder, int i) {
            ...
            navigationMenuItemView.setPadding(i3, i8, i3, i8);
        ...
        public void restoreInstanceState(@NonNull Bundle bundle) {
            ...
            if (sparseParcelableArray != null) {
                ...
                for (int i8 = 0; i8 < size2; i8++) {
                    NavigationMenuItem navigationMenuItem2 = this.items.get(i8);
