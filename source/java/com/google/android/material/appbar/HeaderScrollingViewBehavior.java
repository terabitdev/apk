...
public abstract class HeaderScrollingViewBehavior extends ViewOffsetBehavior<View> {
    ...
    public boolean onMeasureChild(@NonNull CoordinatorLayout coordinatorLayout, @NonNull View view, int i, int i3, int i8, int i10) {
        ...
        if ((i12 == -1 || i12 == -2) && (findFirstDependency = findFirstDependency(coordinatorLayout.getDependencies(view))) != null) {
            ...
            coordinatorLayout.onMeasureChild(view, i, i3, View.MeasureSpec.makeMeasureSpec(scrollRange, i11), i10);
            return true;
        }
        return false;
    }
