...
public abstract class HeaderBehavior<V extends View> extends ViewOffsetBehavior<V> {
    ...
    public final boolean fling(CoordinatorLayout coordinatorLayout, @NonNull V v, int i, int i3, float f7) {
        ...
        this.scroller.fling(0, getTopAndBottomOffset(), 0, Math.round(f7), 0, 0, i, i3);
    ...
    public boolean onInterceptTouchEvent(@NonNull CoordinatorLayout coordinatorLayout, @NonNull V v, @NonNull MotionEvent motionEvent) {
        ...
        if (motionEvent.getActionMasked() == 0) {
            ...
            if (canDragView(v) && coordinatorLayout.isPointInChildBounds(v, x5, y11)) {
                z10 = true;
            } else {
                z10 = false;
            }
    ...
    */
    ...
    public final int scroll(CoordinatorLayout coordinatorLayout, V v, int i, int i3, int i8) {
        return setHeaderTopBottomOffset(coordinatorLayout, v, getTopBottomOffsetForScrollingSibling() - i, i3, i8);
    }

    public int setHeaderTopBottomOffset(CoordinatorLayout coordinatorLayout, V v, int i, int i3, int i8) {
        int clamp;
        int topAndBottomOffset = getTopAndBottomOffset();
        if (i3 != 0 && topAndBottomOffset >= i3 && topAndBottomOffset <= i8 && topAndBottomOffset != (clamp = MathUtils.clamp(i, i3, i8))) {
