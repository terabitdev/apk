...
public final class RTCEngine$createStatsGetter$1 extends n implements l {
    final /* synthetic */ PeerConnectionTransport $p;
    final /* synthetic */ RtpSender $sender;

    /* compiled from: r8-map-id-69a07f5dcb9675c577f44413585e7422b44cd89b2b565101e801beb7a055dae0 */
    @e(c = "io.livekit.android.room.RTCEngine$createStatsGetter$1$1", f = "RTCEngine.kt", l = {1374}, m = "invokeSuspend")
    ...
    public static final class AnonymousClass1 extends i implements p {
        ...
        /* compiled from: r8-map-id-69a07f5dcb9675c577f44413585e7422b44cd89b2b565101e801beb7a055dae0 */
        @e(c = "io.livekit.android.room.RTCEngine$createStatsGetter$1$1$1", f = "RTCEngine.kt", l = {}, m = "invokeSuspend")
        ...
        /* loaded from: classes4.dex */
        public static final class C00551 extends i implements p {
            final /* synthetic */ RtpSender $sender;
            final /* synthetic */ RTCStatsCollectorCallback $statsCallback;
            ...
            public C00551(RtpSender rtpSender, RTCStatsCollectorCallback rTCStatsCollectorCallback, c<? super C00551> cVar) {
                super(2, cVar);
            ...
            public final c<z> create(Object obj, c<?> cVar) {
                C00551 c00551 = new C00551(this.$sender, this.$statsCallback, cVar);
                c00551.L$0 = obj;
                return c00551;
            }
            ...
            public final Object invoke(PeerConnection peerConnection, c<? super z> cVar) {
                return ((C00551) create(peerConnection, cVar)).invokeSuspend(z.f31622a);
            }
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public AnonymousClass1(PeerConnectionTransport peerConnectionTransport, RTCStatsCollectorCallback rTCStatsCollectorCallback, RtpSender rtpSender, c<? super AnonymousClass1> cVar) {
            super(2, cVar);
        ...
        @Override // yn.a
        public final c<z> create(Object obj, c<?> cVar) {
            return new AnonymousClass1(this.$p, this.$statsCallback, this.$sender, cVar);
        }
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (i10 != 0) {
                ...
                if (peerConnectionTransport != null) {
                    C00551 c00551 = new C00551(this.$sender, this.$statsCallback, null);
                    this.label = 1;
                    obj = peerConnectionTransport.withPeerConnection(c00551, this);
    ...
    public final void invoke(RTCStatsCollectorCallback rTCStatsCollectorCallback) {
        ...
        g0.I(wn.i.f37087a, new AnonymousClass1(this.$p, rTCStatsCollectorCallback, this.$sender, null));
    }
