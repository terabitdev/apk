...
public final class Camera2CapturerWithSize extends CameraCapturerWithSize implements CameraVideoCapturer {
    ...
    public Camera2CapturerWithSize(Camera2Capturer camera2Capturer, CameraManager cameraManager, String str, CameraEventsDispatchHandler cameraEventsDispatchHandler) {
        super(cameraEventsDispatchHandler);
        camera2Capturer.getClass();
        cameraManager.getClass();
        cameraEventsDispatchHandler.getClass();
        this.capturer = camera2Capturer;
