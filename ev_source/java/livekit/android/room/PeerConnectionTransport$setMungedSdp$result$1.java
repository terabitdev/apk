...
@e(c = "io.livekit.android.room.PeerConnectionTransport$setMungedSdp$result$1", f = "PeerConnectionTransport.kt", l = {247, 249}, m = "invokeSuspend")
...
public final class PeerConnectionTransport$setMungedSdp$result$1 extends i implements p {
    ...
    public PeerConnectionTransport$setMungedSdp$result$1(boolean z6, PeerConnectionTransport peerConnectionTransport, SessionDescription sessionDescription, c<? super PeerConnectionTransport$setMungedSdp$result$1> cVar) {
        super(2, cVar);
        this.$remote = z6;
    ...
    public final c<z> create(Object obj, c<?> cVar) {
        return new PeerConnectionTransport$setMungedSdp$result$1(this.$remote, this.this$0, this.$sdp, cVar);
    }

    @Override // ho.p
    public final Object invoke(d0 d0Var, c<? super Either<z, String>> cVar) {
        return ((PeerConnectionTransport$setMungedSdp$result$1) create(d0Var, cVar)).invokeSuspend(z.f31622a);
    }
