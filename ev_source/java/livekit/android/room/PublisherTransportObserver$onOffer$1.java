...
public final class PublisherTransportObserver$onOffer$1 extends n implements a {
    final /* synthetic */ SessionDescription $sd;
    final /* synthetic */ PublisherTransportObserver this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public PublisherTransportObserver$onOffer$1(PublisherTransportObserver publisherTransportObserver, SessionDescription sessionDescription) {
        super(0);
    ...
    public final void m2526invoke() {
        ...
        signalClient.sendOffer(this.$sd);
    }
