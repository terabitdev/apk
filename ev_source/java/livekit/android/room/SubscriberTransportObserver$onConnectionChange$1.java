...
public final class SubscriberTransportObserver$onConnectionChange$1 extends n implements a {
    ...
    public SubscriberTransportObserver$onConnectionChange$1(SubscriberTransportObserver subscriberTransportObserver, PeerConnection.PeerConnectionState peerConnectionState) {
        super(0);
    ...
    public final void m2551invoke() {
        ...
        if (LoggingLevel.VERBOSE.compareTo(LKLog.INSTANCE.getLoggingLevel()) >= 0 && d.d() > 0) {
            d.e(null, "onConnectionChange new state: " + peerConnectionState, new Object[0]);
        }
