...
public final class RTCEngine$configure$2$2$2 extends n implements l {
    final /* synthetic */ RTCEngine this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public RTCEngine$configure$2$2$2(RTCEngine rTCEngine) {
        super(1);
    ...
    public final void invoke(PeerConnection.PeerConnectionState peerConnectionState) {
        ...
        if (PeerConnectionExtKt.isDisconnected(peerConnectionState)) {
