...
public final class IncomingDataStreamManagerImpl$getHandlerForInfo$1 extends n implements p {
    final /* synthetic */ p $handler;
    final /* synthetic */ StreamInfo $info;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public IncomingDataStreamManagerImpl$getHandlerForInfo$1(p pVar, StreamInfo streamInfo) {
        super(2);
        this.$handler = pVar;
    ...
    public /* bridge */ /* synthetic */ Object invoke(Object obj, Object obj2) {
        m2554invokeFe0n8cs((hr.n) obj, ((Participant.Identity) obj2).m2610unboximpl());
        return z.f31622a;
    }

    /* renamed from: invoke-Fe0n8cs, reason: not valid java name */
    public final void m2554invokeFe0n8cs(hr.n nVar, String str) {
        nVar.getClass();
        str.getClass();
        p pVar = this.$handler;
        if (pVar == null) {
            ...
            if (LoggingLevel.WARN.compareTo(LKLog.INSTANCE.getLoggingLevel()) >= 0 && d.d() > 0) {
                d.f(null, "Received byte stream for topic \"" + streamInfo.getTopic() + "\", but no handler was found. Ignoring.", new Object[0]);
                return;
            }
            return;
        }
        pVar.invoke(new ByteStreamReceiver((ByteStreamInfo) this.$info, nVar), Participant.Identity.m2604boximpl(str));
    }
}
