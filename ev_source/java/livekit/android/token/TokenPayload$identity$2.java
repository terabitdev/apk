...
public final class TokenPayload$identity$2 extends n implements a {
    final /* synthetic */ TokenPayload this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public TokenPayload$identity$2(TokenPayload tokenPayload) {
        super(0);
    ...
    public final String invoke() {
        ...
        if (subject == null) {
            com.auth0.android.jwt.a aVar = (com.auth0.android.jwt.a) this.this$0.getJwt().f5168c.f5175g.get("identity");
            if (aVar == null) {
                return null;
            }
            f fVar = aVar.f5165a;
