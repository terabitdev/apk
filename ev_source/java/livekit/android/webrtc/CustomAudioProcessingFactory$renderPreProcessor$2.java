...
public final class CustomAudioProcessingFactory$renderPreProcessor$2 extends n implements p {
    final /* synthetic */ CustomAudioProcessingFactory this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public CustomAudioProcessingFactory$renderPreProcessor$2(CustomAudioProcessingFactory customAudioProcessingFactory) {
        super(2);
    ...
    public final void invoke(AudioProcessorInterface audioProcessorInterface, AudioProcessorInterface audioProcessorInterface2) {
        ...
        externalAudioProcessingFactory.setRenderPreProcessing(audioProcessing);
    }
