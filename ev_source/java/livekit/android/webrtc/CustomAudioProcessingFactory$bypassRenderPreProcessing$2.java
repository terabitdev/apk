...
public final class CustomAudioProcessingFactory$bypassRenderPreProcessing$2 extends n implements p {
    final /* synthetic */ CustomAudioProcessingFactory this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public CustomAudioProcessingFactory$bypassRenderPreProcessing$2(CustomAudioProcessingFactory customAudioProcessingFactory) {
        super(2);
    ...
    public final void invoke(boolean z6, boolean z10) {
        ...
        externalAudioProcessingFactory.setBypassFlagForRenderPre(z6);
    }
}
