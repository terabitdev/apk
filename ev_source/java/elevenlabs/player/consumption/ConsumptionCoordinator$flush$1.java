...
@e(c = "io.elevenlabs.player.consumption.ConsumptionCoordinator$flush$1", f = "ConsumptionCoordinator.kt", l = {56}, m = "invokeSuspend", v = 2)
@Metadata(d1 = {"\u0000\f\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\u0010\u0002\u001a\u00020\u0001*\u00020\u0000H\n¢\u0006\u0004\b\u0002\u0010\u0003"}, d2 = {"Lfr/d0;", "Lsn/z;", "<anonymous>", "(Lfr/d0;)V"}, k = 3, mv = {2, 3, 0})
/* loaded from: classes3.dex */
public final class ConsumptionCoordinator$flush$1 extends i implements p {
    final /* synthetic */ ConsumptionSpan $span;
    int label;
    final /* synthetic */ ConsumptionCoordinator this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public ConsumptionCoordinator$flush$1(ConsumptionCoordinator consumptionCoordinator, ConsumptionSpan consumptionSpan, c<? super ConsumptionCoordinator$flush$1> cVar) {
        super(2, cVar);
    ...
    public final c<z> create(Object obj, c<?> cVar) {
        return new ConsumptionCoordinator$flush$1(this.this$0, this.$span, cVar);
    }

    @Override // ho.p
    public final Object invoke(d0 d0Var, c<? super z> cVar) {
        return ((ConsumptionCoordinator$flush$1) create(d0Var, cVar)).invokeSuspend(z.f31622a);
    }
