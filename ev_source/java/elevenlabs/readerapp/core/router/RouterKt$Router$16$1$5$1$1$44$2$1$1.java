...
@yn.e(c = "io.elevenlabs.readerapp.core.router.RouterKt$Router$16$1$5$1$1$44$2$1$1", f = "Router.kt", l = {956}, m = "invokeSuspend", v = 2)
@Metadata(d1 = {"\u0000\f\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\u0010\u0002\u001a\u00020\u0001*\u00020\u0000H\n¢\u0006\u0004\b\u0002\u0010\u0003"}, d2 = {"Lfr/d0;", "Lsn/z;", "<anonymous>", "(Lfr/d0;)V"}, k = 3, mv = {2, 3, 0})
/* loaded from: classes3.dex */
public final class RouterKt$Router$16$1$5$1$1$44$2$1$1 extends yn.i implements ho.p {
    ...
    public RouterKt$Router$16$1$5$1$1$44$2$1$1(na.c0 c0Var, String str, Analytics.Event.PlayerActivationSource playerActivationSource, RouterViewModel routerViewModel, wn.c<? super RouterKt$Router$16$1$5$1$1$44$2$1$1> cVar) {
        super(2, cVar);
    ...
    public final wn.c<sn.z> create(Object obj, wn.c<?> cVar) {
        return new RouterKt$Router$16$1$5$1$1$44$2$1$1(this.$rootNavController, this.$readId, this.$source, this.$vm, cVar);
    }

    @Override // ho.p
    public final Object invoke(fr.d0 d0Var, wn.c<? super sn.z> cVar) {
        return ((RouterKt$Router$16$1$5$1$1$44$2$1$1) create(d0Var, cVar)).invokeSuspend(sn.z.f31622a);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i10 != 0) {
            ...
            sn.a.g(obj);
            Analytics.Event.PlayerAddToQueueClicked.Source source = Analytics.Event.PlayerAddToQueueClicked.Source.ReadDetailsMoreActions;
