...
@yn.e(c = "io.elevenlabs.readerapp.ui.screens.authenticated.home.v4.HomeViewModelV4$onClickAddOrRemoveFromQueue$1", f = "HomeViewModelV4.kt", l = {269, 282}, m = "invokeSuspend", v = 2)
@Metadata(d1 = {"\u0000\f\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\u0010\u0002\u001a\u00020\u0001*\u00020\u0000H\n¢\u0006\u0004\b\u0002\u0010\u0003"}, d2 = {"Lfr/d0;", "Lsn/z;", "<anonymous>", "(Lfr/d0;)V"}, k = 3, mv = {2, 3, 0})
/* loaded from: classes4.dex */
public final class HomeViewModelV4$onClickAddOrRemoveFromQueue$1 extends yn.i implements ho.p {
    final /* synthetic */ ReadMeta $readMeta;
    int label;
    final /* synthetic */ HomeViewModelV4 this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public HomeViewModelV4$onClickAddOrRemoveFromQueue$1(HomeViewModelV4 homeViewModelV4, ReadMeta readMeta, wn.c<? super HomeViewModelV4$onClickAddOrRemoveFromQueue$1> cVar) {
        super(2, cVar);
    ...
    public final wn.c<z> create(Object obj, wn.c<?> cVar) {
        return new HomeViewModelV4$onClickAddOrRemoveFromQueue$1(this.this$0, this.$readMeta, cVar);
    }

    @Override // ho.p
    public final Object invoke(d0 d0Var, wn.c<? super z> cVar) {
        return ((HomeViewModelV4$onClickAddOrRemoveFromQueue$1) create(d0Var, cVar)).invokeSuspend(z.f31622a);
    }
    ...
    */
    public final Object invokeSuspend(Object obj) {
        ...
        if (i10 != 0) {
            ...
            sn.a.g(obj);
            List<MediaItemState> playerQueue = ((HomeStateV4) this.this$0.getStateFlow().getValue()).getPlayerQueue();
