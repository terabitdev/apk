...
@yn.e(c = "io.elevenlabs.readerapp.ui.screens.authenticated.player.PlayerViewModel$bookmarkCurrentParagraph$1", f = "PlayerViewModel.kt", l = {2232, 2238}, m = "invokeSuspend", v = 2)
@Metadata(d1 = {"\u0000\f\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\u0010\u0002\u001a\u00020\u0001*\u00020\u0000H\n¢\u0006\u0004\b\u0002\u0010\u0003"}, d2 = {"Lfr/d0;", "Lsn/z;", "<anonymous>", "(Lfr/d0;)V"}, k = 3, mv = {2, 3, 0})
/* loaded from: classes4.dex */
public final class PlayerViewModel$bookmarkCurrentParagraph$1 extends yn.i implements ho.p {
    Object L$0;
    int label;
    final /* synthetic */ PlayerViewModel this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public PlayerViewModel$bookmarkCurrentParagraph$1(PlayerViewModel playerViewModel, wn.c<? super PlayerViewModel$bookmarkCurrentParagraph$1> cVar) {
        super(2, cVar);
    ...
    public final wn.c<sn.z> create(Object obj, wn.c<?> cVar) {
        return new PlayerViewModel$bookmarkCurrentParagraph$1(this.this$0, cVar);
    }

    @Override // ho.p
    public final Object invoke(fr.d0 d0Var, wn.c<? super sn.z> cVar) {
        return ((PlayerViewModel$bookmarkCurrentParagraph$1) create(d0Var, cVar)).invokeSuspend(sn.z.f31622a);
    }

    /* JADX WARN: Code restructure failed: missing block: B:16:0x0052, code lost:
    
        if (fr.g0.n(r5, r7) == r4) goto L39;
     */
        ...
        if (i10 != 0) {
            if (i10 != 1) {
                if (i10 == 2) {
                    str = (String) this.L$0;
                    sn.a.g(obj);
                    this.this$0.queueStateUpdate(new y1(str, 2));
                    return zVar;
                }
            ...
            Analytics.Event.BookmarksSavedBookmark.BookmarkSource bookmarkSource = Analytics.Event.BookmarksSavedBookmark.BookmarkSource.PlayerBar;
            this.label = 1;
            obj = playerViewModel.bookmarkAtCurrentPlayhead(bookmarkSource, this);
        }
        str = (String) obj;
        if (str != null) {
            this.this$0.queueStateUpdate(new y1(str, 1));
