...
public final class ComposableSingletons$PreviewVoiceFilteredListScreenEmptyDefaultGroupPreviewVoiceFilteredListScreenEmptyKt {
    ...
    private static p lambda$1890594702 = new j(new a(3), false, 1890594702);

    public static final z lambda_1890594702$lambda$0(m mVar, int i10) {
        boolean z6;
        if ((i10 & 3) != 2) {
            z6 = true;
        } else {
    ...
    public final p getLambda$1890594702$app_productionRelease() {
        return lambda$1890594702;
    }
}
