...
@yn.e(c = "io.elevenlabs.readerapp.ui.screens.authenticated.collections.EditCollectionViewModel$submit$1$1", f = "EditCollectionScreen.kt", l = {85}, m = "invokeSuspend", v = 2)
@Metadata(d1 = {"\u0000\f\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\u0010\u0002\u001a\u00020\u0001*\u00020\u0000H\n¢\u0006\u0004\b\u0002\u0010\u0003"}, d2 = {"Lfr/d0;", "Lsn/z;", "<anonymous>", "(Lfr/d0;)V"}, k = 3, mv = {2, 3, 0})
/* loaded from: classes4.dex */
public final class EditCollectionViewModel$submit$1$1 extends yn.i implements ho.p {
    final /* synthetic */ EditCollectionState $this_queueStateUpdate;
    int label;
    final /* synthetic */ EditCollectionViewModel this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public EditCollectionViewModel$submit$1$1(EditCollectionViewModel editCollectionViewModel, EditCollectionState editCollectionState, wn.c<? super EditCollectionViewModel$submit$1$1> cVar) {
        super(2, cVar);
        this.this$0 = editCollectionViewModel;
        this.$this_queueStateUpdate = editCollectionState;
    }

    @Override // yn.a
    public final wn.c<sn.z> create(Object obj, wn.c<?> cVar) {
        return new EditCollectionViewModel$submit$1$1(this.this$0, this.$this_queueStateUpdate, cVar);
    }

    @Override // ho.p
    public final Object invoke(fr.d0 d0Var, wn.c<? super sn.z> cVar) {
        return ((EditCollectionViewModel$submit$1$1) create(d0Var, cVar)).invokeSuspend(sn.z.f31622a);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i10 != 0) {
            ...
            this.label = 1;
            obj = collectionsService.updateCollection(collectionId, name, icon, this);
        ...
        if (asyncCallResult instanceof AsyncCallResult.Error) {
            ...
            this.this$0.queueStateUpdate(new o(9));
        } else if (asyncCallResult instanceof AsyncCallResult.Success) {
            this.this$0.queueStateUpdate(new o(10));
        } else {
            c6.p();
            return null;
        }
