...
@yn.e(c = "io.elevenlabs.readerapp.ui.screens.authenticated.collections.CollectionViewModel$onClickAddOrRemoveFromQueue$1", f = "CollectionViewModel.kt", l = {244, 258}, m = "invokeSuspend", v = 2)
@Metadata(d1 = {"\u0000\f\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\u0010\u0002\u001a\u00020\u0001*\u00020\u0000H\n¢\u0006\u0004\b\u0002\u0010\u0003"}, d2 = {"Lfr/d0;", "Lsn/z;", "<anonymous>", "(Lfr/d0;)V"}, k = 3, mv = {2, 3, 0})
/* loaded from: classes4.dex */
public final class CollectionViewModel$onClickAddOrRemoveFromQueue$1 extends yn.i implements ho.p {
    final /* synthetic */ ReadMeta $readMeta;
    int label;
    final /* synthetic */ CollectionViewModel this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public CollectionViewModel$onClickAddOrRemoveFromQueue$1(CollectionViewModel collectionViewModel, ReadMeta readMeta, wn.c<? super CollectionViewModel$onClickAddOrRemoveFromQueue$1> cVar) {
        super(2, cVar);
    ...
    public final wn.c<sn.z> create(Object obj, wn.c<?> cVar) {
        return new CollectionViewModel$onClickAddOrRemoveFromQueue$1(this.this$0, this.$readMeta, cVar);
    }

    @Override // ho.p
    public final Object invoke(fr.d0 d0Var, wn.c<? super sn.z> cVar) {
        return ((CollectionViewModel$onClickAddOrRemoveFromQueue$1) create(d0Var, cVar)).invokeSuspend(sn.z.f31622a);
    }
        ...
        if (i10 != 0) {
            if (i10 != 1) {
                if (i10 == 2) {
                    ...
                    analytics2.log(new Analytics.Event.PlayerAddToQueueClicked(Analytics.Event.PlayerAddToQueueClicked.Source.CollectionDetailsLongClick, this.$readMeta.getReadId(), ((CollectionState) this.this$0.getStateFlow().getValue()).getCollectionId()));
                } else {
                ...
                analytics.log(new Analytics.Event.PlayerRemoveFromQueueClicked(Analytics.Event.PlayerRemoveFromQueueClicked.Source.CollectionDetailsLongClick, this.$readMeta.getReadId(), ((CollectionState) this.this$0.getStateFlow().getValue()).getCollectionId(), null, 8, null));
            }
        } else {
            sn.a.g(obj);
            List<MediaItemState> playerQueue = ((CollectionState) this.this$0.getStateFlow().getValue()).getPlayerQueue();
