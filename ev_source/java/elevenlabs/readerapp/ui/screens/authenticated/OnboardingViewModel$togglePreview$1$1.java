...
@yn.e(c = "io.elevenlabs.readerapp.ui.screens.authenticated.OnboardingViewModel$togglePreview$1$1", f = "OnboardingScreen.kt", l = {416}, m = "invokeSuspend", v = 2)
@Metadata(d1 = {"\u0000\f\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\u0010\u0002\u001a\u00020\u0001*\u00020\u0000H\n¢\u0006\u0004\b\u0002\u0010\u0003"}, d2 = {"Lfr/d0;", "Lsn/z;", "<anonymous>", "(Lfr/d0;)V"}, k = 3, mv = {2, 3, 0})
/* loaded from: classes4.dex */
public final class OnboardingViewModel$togglePreview$1$1 extends yn.i implements ho.p {
    ...
    public OnboardingViewModel$togglePreview$1$1(Voice voice, OnboardingViewModel onboardingViewModel, wn.c<? super OnboardingViewModel$togglePreview$1$1> cVar) {
        super(2, cVar);
        this.$voice = voice;
    ...
    public final wn.c<sn.z> create(Object obj, wn.c<?> cVar) {
        return new OnboardingViewModel$togglePreview$1$1(this.$voice, this.this$0, cVar);
    }

    @Override // ho.p
    public final Object invoke(fr.d0 d0Var, wn.c<? super sn.z> cVar) {
        return ((OnboardingViewModel$togglePreview$1$1) create(d0Var, cVar)).invokeSuspend(sn.z.f31622a);
    }
    ...
    */
    public final Object invokeSuspend(Object obj) {
        ...
        if (i10 != 0) {
            ...
            sn.a.g(obj);
            String previewUrl = this.$voice.getPreviewUrl();
            ...
            this.this$0.queueStateUpdate(new w(5));
            return sn.z.f31622a;
        }
