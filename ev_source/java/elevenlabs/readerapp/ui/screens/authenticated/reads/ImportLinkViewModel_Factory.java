...
public final class ImportLinkViewModel_Factory implements ul.c {
    ...
    private ImportLinkViewModel_Factory(ul.f fVar, ul.f fVar2, ul.f fVar3, ul.f fVar4, ul.f fVar5, ul.f fVar6, ul.f fVar7, ul.f fVar8) {
    ...
    public static ImportLinkViewModel_Factory create(ul.f fVar, ul.f fVar2, ul.f fVar3, ul.f fVar4, ul.f fVar5, ul.f fVar6, ul.f fVar7, ul.f fVar8) {
        return new ImportLinkViewModel_Factory(fVar, fVar2, fVar3, fVar4, fVar5, fVar6, fVar7, fVar8);
    }

    public static ImportLinkViewModel newInstance(DispatcherFactory dispatcherFactory, jl.a aVar, jl.a aVar2, FileService fileService, Logger logger, Analytics analytics, ResolveErrorMessageUseCase resolveErrorMessageUseCase, jl.a aVar3) {
        return new ImportLinkViewModel(dispatcherFactory, aVar, aVar2, fileService, logger, analytics, resolveErrorMessageUseCase, aVar3);
    }

    @Override // rn.a
    public ImportLinkViewModel get() {
        return newInstance((DispatcherFactory) this.dispatcherFactoryProvider.get(), ul.b.a(this.readsServiceProvider), ul.b.a(this.stringProvider), (FileService) this.fileServiceProvider.get(), (Logger) this.loggerProvider.get(), (Analytics) this.analyticsProvider.get(), (ResolveErrorMessageUseCase) this.resolveErrorMessageUseCaseProvider.get(), ul.b.a(this.showImportingContentToastProvider));
    }
}
