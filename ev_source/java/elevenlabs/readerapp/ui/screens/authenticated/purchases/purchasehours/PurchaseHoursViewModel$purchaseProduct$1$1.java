...
@yn.e(c = "io.elevenlabs.readerapp.ui.screens.authenticated.purchases.purchasehours.PurchaseHoursViewModel$purchaseProduct$1$1", f = "PurchaseHoursViewModel.kt", l = {88}, m = "invokeSuspend", v = 2)
@Metadata(d1 = {"\u0000\f\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\u0010\u0002\u001a\u00020\u0001*\u00020\u0000H\n¢\u0006\u0004\b\u0002\u0010\u0003"}, d2 = {"Lfr/d0;", "Lsn/z;", "<anonymous>", "(Lfr/d0;)V"}, k = 3, mv = {2, 3, 0})
/* loaded from: classes4.dex */
public final class PurchaseHoursViewModel$purchaseProduct$1$1 extends yn.i implements p {
    ...
    public PurchaseHoursViewModel$purchaseProduct$1$1(PurchaseHoursViewModel purchaseHoursViewModel, OneTimeCreditsProduct oneTimeCreditsProduct, Activity activity, Analytics.Event.CreditPackSource creditPackSource, wn.c<? super PurchaseHoursViewModel$purchaseProduct$1$1> cVar) {
        super(2, cVar);
    ...
    public static final PurchaseHoursState invokeSuspend$lambda$0(PurchaseHoursViewModel purchaseHoursViewModel, AsyncCallResult asyncCallResult, PurchaseHoursState purchaseHoursState) {
        ...
        return PurchaseHoursState.copy$default(purchaseHoursState, false, null, ResolveErrorMessageUseCase.invoke$default(resolveErrorMessageUseCase, (AsyncCallResult.Error) asyncCallResult, null, 2, null), null, false, null, null, 107, null);
    }

    public static final PurchaseHoursState invokeSuspend$lambda$3(OneTimeCreditsProduct oneTimeCreditsProduct, PurchaseHoursState purchaseHoursState) {
        return PurchaseHoursState.copy$default(purchaseHoursState, false, null, null, null, false, oneTimeCreditsProduct, null, 79, null);
    }

    @Override // yn.a
    public final wn.c<z> create(Object obj, wn.c<?> cVar) {
        return new PurchaseHoursViewModel$purchaseProduct$1$1(this.this$0, this.$product, this.$activity, this.$creditPackSource, cVar);
    }

    @Override // ho.p
    public final Object invoke(d0 d0Var, wn.c<? super z> cVar) {
        return ((PurchaseHoursViewModel$purchaseProduct$1$1) create(d0Var, cVar)).invokeSuspend(z.f31622a);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (asyncCallResult instanceof AsyncCallResult.Error) {
            ...
            purchaseHoursViewModel.queueStateUpdate(new l(purchaseHoursViewModel, (AsyncCallResult.Error) asyncCallResult, 1));
            ...
            if (kotlin.jvm.internal.m.c(purchaseResult, PurchasesService.PurchaseResult.Cancelled.INSTANCE)) {
                ...
                this.this$0.queueStateUpdate(new k(this.$product, 2));
                PurchaseHoursViewModel purchaseHoursViewModel2 = this.this$0;
